...
st.title("Nigeria Waterpoint Identification Tool – v1.0")
st.caption("Version 1.0 – Planning tool for identifying chlorine intervention waterpoints")
...
6. Download filtered results for planning or field teams.
...
Estimated households within a 300 m radius of the waterpoint using high-resolution population grids.

This approximates households **likely to collect water from the source**.
...
# Eligible chlorine candidate sites
df["eligible"] = (
...
st.sidebar.write(f"Selected minimum population: **{min_pop}**")
...
st.sidebar.write(f"Selected households within 300m: **{min_hh}**")
